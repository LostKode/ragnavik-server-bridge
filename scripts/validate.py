...
required = {
    ...
    "workflow package": "Ragnavik_Server_Bridge-${{ inputs.expected_version }}.zip" in workflow,
    "Hexium package": "Ragnavik_Server_Bridge-${{ inputs.expected_version }}.zip" in hexium_workflow,
