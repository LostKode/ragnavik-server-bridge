...
| Version | Changes |
| --- | --- |
| 1.0.6 | Report each server-known player's private boss defeat keys from World Advancement Progression so player-based boss totals remain available when players are offline. |
